    ...
    return (
        <form className="mt-5 flex flex-col justify-center items-center">
            ...
            <div className="flex flex-row gap-5 justify-between w-[80%] items-center">
                ...
                <input className="font-bold border-3 outline-none border-appleslice bg-wheat focus:border-burlywood focus:bg-moccasin rounded-full py-1 px-4 text-center flex-1 focus:scale-[1.05] transition-all duration-300" type="text"></input>
            </div>
        </form>
    );
}